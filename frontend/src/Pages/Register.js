...
const Register = () => {
  ...
  return (
    // Container: Dark slate background, fuchsia border, and a subtle glowing shadow.
    <div className='min-h-[60vh] max-w-md w-11/12 mx-auto bg-slate-900 border border-fuchsia-500/30 rounded-2xl shadow-[0_0_30px_rgba(192,38,211,0.15)] flex flex-col items-center justify-center gap-4 p-8 mt-24'>
      ...
      {/* Title: Gradient text to match the platform */}
      <h1 className='font-bold text-4xl text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-cyan-400 pb-2 mb-4'>REGISTER</h1>
      
      {/* Form: Clean flexbox gaps */}
      <form onSubmit={handleSubmit} className='w-full flex flex-col gap-5'>
        ...
        {/* Button: Fuchsia background with a neon glow effect on hover */}
        <button 
          disabled={isLoading} 
          type="submit" 
      ...
      {/* Link: Cyan styling to match the login page */}
